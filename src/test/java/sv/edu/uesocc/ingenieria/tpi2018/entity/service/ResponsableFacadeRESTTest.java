...
public class ResponsableFacadeRESTTest {
    
    private ResponsableFacadeREST mockResponsableFacadeREST;
    ...
    public ResponsableFacadeRESTTest() {
    }
    ...
    public void inicializarForEach() throws Exception {
        ...
        mockResponsableFacadeREST=Mockito.mock(ResponsableFacadeREST.class);
        ...
        Mockito.when(mockContexto.lookup("java:global/classes/CalendarioFacadeREST")).thenReturn((ResponsableFacadeREST)mockResponsableFacadeREST);     
    }
    ...
    public void testEdit_GenericType() throws Exception {
        ...
        Responsable result=Mockito.mock(Responsable.class);
        
        Mockito.when(mockResponsableFacadeREST.find(id)).thenReturn(result);
        Mockito.when(result.getIdResponsable()).thenReturn(id);
        assertThat(result, CoreMatchers.is(Responsable.class));
        assertEquals(id,result.getIdResponsable());
        
        Mockito.doNothing().when(mockResponsableFacadeREST).edit(result);
    }
    ...
    public void testRemove_GenericType() throws Exception {
        ...
        Mockito.doNothing().when(mockResponsableFacadeREST).remove(result);
    }
    ...
    public void testFindRange_intArr() throws Exception {
        ...
        int[] range = {1,50};
        List<Responsable> result=Mockito.mock(List.class);
        
        Mockito.when(mockResponsableFacadeREST.findRange(range)).thenReturn(result);
    ...
    public void testCount() throws Exception {
        ...
        int expResult = 1;
        int result=0;
        Mockito.when(mockResponsableFacadeREST.count()).thenReturn(1);
        result = mockResponsableFacadeREST.count();
    ...
    public void testCreate() throws Exception {
        ...
        Mockito.doNothing().when(mockResponsableFacadeREST).create(entity);
    }
    ...
    public void testFindAll() throws Exception {
        ...
        List<Responsable> result = Mockito.mock(List.class);
        Mockito.when(mockResponsableFacadeREST.findAll()).thenReturn(result);
