...
public class DiagnosticoParteFacadeRESTTest {
    
    private DiagnosticoParteFacadeREST mockDiagnosticoParteFacadeREST;
    ...
    public DiagnosticoParteFacadeRESTTest() {
    }
    ...
    public void inicializarForEach() throws Exception {
        ...
        mockDiagnosticoParteFacadeREST=Mockito.mock(DiagnosticoParteFacadeREST.class);
        ...
        Mockito.when(mockContexto.lookup("java:global/classes/CalendarioFacadeREST")).thenReturn((DiagnosticoParteFacadeREST)mockDiagnosticoParteFacadeREST);     
    }
    ...
    public void testEdit_GenericType() throws Exception {
        ...
        String id="ruta";
        DiagnosticoParte result=Mockito.mock(DiagnosticoParte.class);
        
        Mockito.when(mockDiagnosticoParteFacadeREST.find(id)).thenReturn(result);
        Mockito.when(result.getDescripcion()).thenReturn(id);
        assertThat(result, CoreMatchers.is(DiagnosticoParte.class));
        assertEquals(id,result.getDescripcion());
        
        Mockito.doNothing().when(mockDiagnosticoParteFacadeREST).edit(result);
    }
    ...
    public void testRemove_GenericType() throws Exception {
        ...
        Mockito.doNothing().when(mockDiagnosticoParteFacadeREST).remove(result);
    }
    ...
    public void testFindRange_intArr() throws Exception {
        ...
        int[] range = {1,50};
        List<DiagnosticoParte> result=Mockito.mock(List.class);
        
        Mockito.when(mockDiagnosticoParteFacadeREST.findRange(range)).thenReturn(result);
    ...
    public void testCount() throws Exception {
        ...
        int expResult = 1;
        int result=0;
        Mockito.when(mockDiagnosticoParteFacadeREST.count()).thenReturn(1);
        result = mockDiagnosticoParteFacadeREST.count();
    ...
    public void testCreate() throws Exception {
        ...
        Mockito.doNothing().when(mockDiagnosticoParteFacadeREST).create(entity);
    }
    ...
    public void testFindAll() throws Exception {
        ...
        List<DiagnosticoParte> result = Mockito.mock(List.class);
        Mockito.when(mockDiagnosticoParteFacadeREST.findAll()).thenReturn(result);
