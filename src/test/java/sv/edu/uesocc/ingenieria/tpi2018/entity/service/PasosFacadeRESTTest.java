...
import sv.edu.uesocc.ingenieria.tpi2018.entity.Pasos;
...
public class PasosFacadeRESTTest {
    
    public PasosFacadeRESTTest() {
    }
    
    private PasosFacadeREST mockPasosFacadeREST;
    ...
    public void inicializarForEach() throws Exception {
        ...
        mockPasosFacadeREST=Mockito.mock(PasosFacadeREST.class);
        ...
        Mockito.when(mockContexto.lookup("java:global/classes/CalendarioFacadeREST")).thenReturn((PasosFacadeREST)mockPasosFacadeREST);     
    }
    ...
    /**
     * Test of edit method, of class PasosFacadeREST.
     */
    @Test
    public void testEdit_GenericType() throws Exception {
        System.out.println("edit");
        Integer id=new Integer(1);
        Pasos result=Mockito.mock(Pasos.class);
        
        Mockito.when(mockPasosFacadeREST.find(id)).thenReturn(result);
        Mockito.when(result.getIdPasos()).thenReturn(id);
        assertThat(result, CoreMatchers.is(Pasos.class));
        assertEquals(id,result.getIdPasos());
        
        Mockito.doNothing().when(mockPasosFacadeREST).edit(result);
    }

    /**
     * Test of remove method, of class PasosFacadeREST.
     */
    @Test
    public void testRemove_GenericType() throws Exception {
        ...
        Mockito.doNothing().when(mockPasosFacadeREST).remove(result);
    }

    /**
     * Test of find method, of class PasosFacadeREST.
     */
    @Test
    ...
    /**
     * Test of findRange method, of class PasosFacadeREST.
     */
    @Test
    public void testFindRange_intArr() throws Exception {
        System.out.println("findRange");
        int[] range = {1,50};
        List<Pasos> result=Mockito.mock(List.class);
        
        Mockito.when(mockPasosFacadeREST.findRange(range)).thenReturn(result);
        Mockito.when(result.size()).thenReturn(2);
        assertEquals(2,result.size());
    }

    /**
     * Test of count method, of class PasosFacadeREST.
     */
    @Test
    public void testCount() throws Exception {
        ...
        int expResult = 1;
        int result=0;
        Mockito.when(mockPasosFacadeREST.count()).thenReturn(1);
        result = mockPasosFacadeREST.count();
        assertEquals(expResult, result);
    }

    /**
     * Test of create method, of class PasosFacadeREST.
     */
    @Test
    public void testCreate() throws Exception {
        System.out.println("create");
        Pasos entity = new Pasos();
        Mockito.doNothing().when(mockPasosFacadeREST).create(entity);
    }


    /**
     * Test of findAll method, of class PasosFacadeREST.
     */
    @Test
    public void testFindAll() throws Exception {
        System.out.println("findAll");
        List<Pasos> result = Mockito.mock(List.class);
        Mockito.when(mockPasosFacadeREST.findAll()).thenReturn(result);
