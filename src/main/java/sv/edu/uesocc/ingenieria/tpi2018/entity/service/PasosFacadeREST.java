...
public class PasosFacadeREST extends AbstractFacade<Pasos> {
    ...
    public Pasos find(@PathParam("id") Integer id) {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<Pasos> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
